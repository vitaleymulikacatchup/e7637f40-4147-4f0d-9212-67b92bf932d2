...
export const metadata: Metadata = {
  title: "Zootopia - Officer Hops Official Movie Site",
  description: "Meet Officer Judy Hops in Zootopia. Watch the award-winning animated adventure featuring a determined rabbit cop solving mysteries in the bustling city.",
  keywords: "Zootopia, Officer Hops, animated movie, Disney, adventure, comedy, family film",
  metadataBase: new URL("https://www.zootopia-movie.com"),
  alternates: {
    canonical: "https://www.zootopia-movie.com"
  },
  openGraph: {
    title: "Zootopia - Officer Hops Official Movie Site",
    description: "Meet Officer Judy Hops in Zootopia. Watch the award-winning animated adventure featuring a determined rabbit cop solving mysteries.",
    url: "https://www.zootopia-movie.com",
    siteName: "Zootopia",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766070251154-sdtxcxjs.jpg",
  ...
  twitter: {
    ...
    title: "Zootopia - Officer Hops Official Movie Site",
    description: "Meet Officer Judy Hops in Zootopia. Watch the award-winning animated adventure now.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766070246285-w1rjlolc.jpg"]
  },
  robots: {
    index: true,
    follow: true
